...
class EpisodicDataset(torch.utils.data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        return image_data, qpos_data, action_data, is_pad, uv_norm_t, aux_valid_t
...
def load_data(dataset_dir, num_episodes, camera_names, batch_size_train, batch_size_val):
    ...
    val_dataloader = DataLoader(val_dataset, batch_size=batch_size_val, shuffle=True, pin_memory=True, num_workers=8, prefetch_factor=4, persistent_workers=True)
